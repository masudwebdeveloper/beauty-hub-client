...
const Treatments = () => {
  ...
  return (
    <div className="lg:w-[1350px] mx-auto py-10 mb-24">
        <h1 className="mx-auto font-bold text-2xl py-2 px-4 text-center text-opacity-75 hover:text-opacity-100 border w-[450px] shadow-inner hover:shadow-gray-500 duration-500 cursor-pointer">
