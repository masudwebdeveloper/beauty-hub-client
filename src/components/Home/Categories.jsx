...
const Categories = () => {
  ...
  // const key = "category";
  // const allCategories = [...new Map(categories.map(item => [item[key], item])).values()];
  ...
  return (
    <div className="lg:w-[1350px] mx-auto py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-12 px-3 lg:p-10 lg:pb-14  bg-slate-50 rounded shadow-2xl overflow-hidden">
